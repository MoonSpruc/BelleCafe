(() => {
    ...
    if (document.querySelector(".testimonial__slider")) new Swiper(".testimonial__slider", {
        ...
        speed: 800,
        pagination: {
            el: ".controll-testimonial__progressbar",
            clickable: true,
            type: "progressbar"
        },
        navigation: {
            prevEl: ".controll-testimonial__button-prev",
            nextEl: ".controll-testimonial__button-next"
        },
        breakpoints: {
            320: {
                slidesPerView: 1,
        ...
        on: {
            ...
            slideChange: function(swiper) {
                ...
                currentSlide.innerHTML = swiper.activeIndex + 2;
                if (innerWidth < 480) currentSlide.innerHTML = swiper.activeIndex + 1;
            }
        }
    });
    const modules_andModules = {};
    class animation_Parallax {
        constructor(elements) {
            if (elements.length) this.elements = Array.from(elements).map((el => new animation_Parallax.Each(el, this.options)));
        }
        destroyEvents() {
    ...
    animation_Parallax.Each = class {
        constructor(parent) {
            this.parent = parent;
            this.elements = this.parent.querySelectorAll("[data-anim]");
    ...
    if (document.querySelectorAll("[data-anim-parent]")) modules_andModules.parallax = new animation_Parallax(document.querySelectorAll("[data-anim-parent]"));
    console.log("Анимация Есть");
    "use strict";
    ...
    document.querySelector(".hero__button--play").addEventListener("click", (function() {
